  ...
  return (
    <div className="max-w-screen-xl mx-auto px-2 sm:px-4 md:px-6 py-6">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold text-foreground">Latest Uploads</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-muted-foreground max-w-sm">Be the first to upload and share your content with the community!</p>
        </div>
      ) : (
        <>
